    ...
    >
      <div className="relative w-full max-w-5xl px-6 md:px-10 text-center space-y-6">
        ...
        <p className="mt-4 text-ivory/80 text-sm md:text-xl lg:text-base max-w-2xl mx-auto leading-relaxed">
          A personalized design experience creating refined pieces that reflect
          your vision, moments, and individuality.
        </p>

        <LinkButton href="/shop" label="Shop Now" size="sm" variant="primary" />
      </div>
    </section>
  );
};
